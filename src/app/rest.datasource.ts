...
@Injectable() export class RestDataSource { 
    ...
    private collectionArtworkUrl = this.APIURL + this.configSettings.citizenDatasetUUID + '?query=%7B%22type%22:%22collectionartwork%22%7D&limit=9999';
    ...
    //Collection artwork
    getCollectionArtworkData(): Observable<CollectionArtwork[]> {
        return this.http.get<CollectionArtwork[]>(this.collectionArtworkUrl, this.configSettings.config);
        // return this.http.get<CollectionArtwork[]>(this.collectionArtworkUrl);
    }

    saveCollectionArtwork(collectionArtwork: CollectionArtwork): Observable<CollectionArtwork> {
        return this.http.post<CollectionArtwork>(this.saveUrl, collectionArtwork, this.configSettings.config);
        // return this.http.post<CollectionArtwork>(this.saveUrl, user);
    }

    updateCollectionArtwork(collectionArtwork: CollectionArtwork) {
        return this.http.put<CollectionArtwork>(`${this.saveUrl}/${collectionArtwork._id}`, collectionArtwork, this.configSettings.config);
        // return this.http.put<CollectionArtwork>(`${this.saveUrl}/${user._id}`, user);
    }

    deleteCollectionArtwork(_id: string) {
        return this.http.delete<CollectionArtwork>(`${this.saveUrl}/${_id}`, this.configSettings.config);
        // return this.http.delete<CollectionArtwork>(`${this.saveUrl}/${_id}`);
    }
    ...
    getScriptSetData(): Observable<ScriptSet[]> { 
        return this.http.get<ScriptSet[]>(this.scriptsetUrl, this.configSettings.config); 
